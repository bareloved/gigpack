...
**CRITICAL RULE**: Only `README.md` stays in repository root. All other `.md` files belong in `/docs/` subdirectories with this structure:

```
docs/
├── overview/          # High-level app docs (this file)
├── setup/            # Setup/run/deploy instructions
├── architecture/     # Routing, data flow, i18n architecture
...
**Future agents**: Always follow this structure. Never create `.md` files in repository root.
